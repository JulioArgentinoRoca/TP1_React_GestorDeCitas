...
function appointment(props){
    ...
    return (
        <div className="cita">
              ...
              <p>Sintomas: <span>{props.syntoms}</span></p><button className="button elimnar u-full-width" onClick={() => deleteAppointment()}>Eliminar ×</button>
        </div>
    )
}
